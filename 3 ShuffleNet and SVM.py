...
# ShuffleNet model for feature extraction
...
# Extract features using ShuffleNet
...
import joblib
joblib.dump(svm_clf, "svm_model_shufflenet.pkl")
print("SVM model saved as svm_model_shufflenet.pkl")
